var CarbonComponents = (function (exports) {
  ...
  function (_mixin) {
    ...
    function TextArea(_element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), "_handleInput", function (_ref) {
        var element = _ref.element,
            length = _ref.length;
  ...
  _defineProperty(TextArea, "components",
  /* #__PURE_CLASS_PROPERTY__ */
  new WeakMap());
  ...
  function (_mixin) {
    ...
    function TextInput(_element, options) {
      ...
      _defineProperty(_assertThisInitialized(_this), "_setIconVisibility", function (_ref2) {
      ...
      _defineProperty(_assertThisInitialized(_this), "_toggle", function (_ref3) {
        var element = _ref3.element,
            button = _ref3.button;
